...
public class ActionPlanning : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Actions.Add("Peel_Avocado", new Action(
            "Peel_Avocado",
            new Dictionary<string, int> {["avocado"] = 1, ["avocado_empty"] = 1},
            new Dictionary<string, int> {["avocado_whole"] = 1},
            new Dictionary<string, int> {["avocado_whole"] = 1},
            new List<string>(){"knife", "spoon"},
            new int[]{},
            "cuttingTable"
        ));
        Actions.Add("Cook_Bacon", new Action(
            "Cook_Bacon",
        ...
        Actions.Add("Slice_Bread", new Action(
            "Slice_Bread",
            new Dictionary<string, int> {["breadSlice"] = 8},
            new Dictionary<string, int> {["breadLoaf"] = 1},
            new Dictionary<string, int> {["breadLoaf"] = 1},
            new List<string>(){"knife"},
            new int[]{},
            "cuttingTable"
        ));
        Actions.Add("Assemble_Burger", new Action(
            "Assemble_Burger",
        ...
        Actions.Add("Assemble_Cheeseburger", new Action(
        ...
        Actions.Add("Assemble_DoubleCheeseburger", new Action(
        ...
        Actions.Add("Fry_Patty", new Action(
            "Fry_Patty",
            new Dictionary<string, int> {["patty_cooked"] = 1},
            new Dictionary<string, int> {["patty_burned"] = 1},
            new Dictionary<string, int> {["patty_raw"] = 2},
            new List<string>(){"oil"},
            new int[]{},
            "stove"
        ));
        Actions.Add("Split_Coconut", new Action(
            "Split_Coconut",
        ...
        Actions.Add("Fry_Egg", new Action(
            "Fry_Egg",
        ...
        Actions.Add("Fry_Egg_White", new Action(
            "Fry_Egg_White",
            new Dictionary<string, int> {["egg_fried"] = 1},
            new Dictionary<string, int> {["egg_burned"] = 1},
        ...
        Actions.Add("Assemble_Hotdog", new Action(
            "Assemble_Hotdog",
        ...
        Actions.Add("Cook_Sausage", new Action(
            "Cook_Sausage",
        ...
        Actions.Add("Cut_Lettuce", new Action(
            "Cut_Lettuce",
        ...
        Actions.Add("Stack_Pancakes", new Action(
            "Stack_Pancakes",
        ...
        Actions.Add("Cut_Pizza", new Action(
            "Cut_Pizza",
        ...
        Actions.Add("Prepare_Sashimi_1", new Action(
            "Prepare_Sashimi_1",
        ...
        Actions.Add("Prepare_Sashimi_2", new Action(
            "Prepare_Sashimi_2",
            new Dictionary<string, int> {["sashimi_1"] = 1, ["fishbone"] = 1},
            new Dictionary<string, int> {["fishbone"] = 1},
            new Dictionary<string, int> {["fish"] = 1},
            new List<string>(){"knife", "soySauce"},
            new int[]{},
            "cuttingTable"
        ));
        Actions.Add("Prepare_Nigiri_1", new Action(
            "Prepare_Nigiri_1",
        ...
        Actions.Add("Prepare_Nigiri_2", new Action(
            "Prepare_Nigiri_2",
            new Dictionary<string, int> {["nigiri_1"] = 1, ["fishbone"] = 1},
            new Dictionary<string, int> {["fishbone"] = 1},
            new Dictionary<string, int> {["fish"] = 1},
        ...
        Actions.Add("Prepare_Nigiri_Octopus", new Action(
        ...
        Actions.Add("Cook_Steak", new Action(
            "Cook_Steak",
        ...
        Actions.Add("Prepare_SushiRoll_1", new Action(
            "Prepare_SushiRoll_1",
        ...
        Actions.Add("Prepare_SushiRoll_2", new Action(
            "Prepare_SushiRoll_2",
        ...
        Actions.Add("Cut_Tomato", new Action(
            "Cut_Tomato",
